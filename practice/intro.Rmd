...
Now try to add a line geom to the plot as well, using `geom_line()`.
...
have time while waiting for the others to finish, install
[ggthemes](https://cran.r-project.org/package=ggthemes) and play around with
some of the themes in that packages.
